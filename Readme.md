...
1. **Entendimento da base:** leitura das variáveis, identificação de tipos de dados, nulos e valores únicos
2. **Limpeza e decisões metodológicas:** exclusão de categorias com amostra pequena, documentadas por transparência
3. **Tabelas dinâmicas:** cada análise construída com filtros específicos e valores calculados como % da linha para comparação proporcional
4. **Visualizações:** gráficos de barras horizontais empilhadas com paleta de cores padronizada em degradê de roxo
...
👉 [Acessar Dashboard — Análise de Diversidade 2022](https://datastudio.google.com/u/0/reporting/37911122-1e3a-4a0d-940c-621fdecfacaf/page/IlyyF)
...
Dados: [Data Hackers Survey 2022](https://www.kaggle.com/datasets/datahackers/pesquisa-data-hackers-2022)
